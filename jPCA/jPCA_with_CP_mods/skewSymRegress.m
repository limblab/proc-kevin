...
%     m0 = jPCA_with_CP_mods.reshapeSkew(M0k);
    m0 = reshapeSkew(M0k); % I'm not really sure what this dot notation is...
    %m0 = zeros(size(m0));
...
%     [m, fM, i] = jPCA_with_CP_mods.minimize( m0 , 'jPCA_with_CP_mods.skewSymLSeval' , 1000, dX , X );
    ...
    % return the matrix
%     M = jPCA_with_CP_mods.reshapeSkew(m);
    M = reshapeSkew(m); % again, not sure what this dot notation is...
